<template>
  <div id="product">
    ...
    <el-table :data="products" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="categoryId" label="所属栏目" align="center" />
    ...
    <el-dialog :title="title" :visible.sync="visible" @close="dialogCloseHandler">
      <el-form ref="productForm" :model="product" :rules="rules">
        <el-form-item label="名称" label-width="100px" prop="name">
          <el-input v-model="product.name" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="价格" label-width="100px" prop="price">
          <el-input v-model="product.price" autocomplete="off" clearable />
        </el-form-item>
        ...
        <el-form-item label="描述" label-width="100px" prop="description">
          <el-input v-model="product.description" autocomplete="off" clearable type="textarea" />
        </el-form-item>
